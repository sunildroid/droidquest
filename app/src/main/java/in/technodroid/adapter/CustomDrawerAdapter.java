...
/**
 * Created by Sunil Kuntal on 9/2/2015.
 */
...
import in.technodroid.model.DrawerItem;
import in.technodroid.swap.R;

//import in.technodroid.model.SpinnerItem;
...
/*
        ...
        if (dItem.isSpinner()) {
            ...
            userList.add(new SpinnerItem(R.drawable.user1, "Sunil Kuntal ",
                    "ishakgmail.com"));

            userList.add(new SpinnerItem(R.drawable.user1, "Kuntal Sunil",
                    "brain.jgmail.com"));
